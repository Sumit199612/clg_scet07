									...
									<li class="header">Messages</li>
										<li class="body">
											<ul class="menu">
												...
												<li> <a href="javascript:void(0);">
													<div class="icon-circle"> <img src="{{asset('assets/images/xs/avatar2.jpg')}}" alt=""> </div>
													<div class="menu-info">
														<h4>Jacob Smith</h4>
														<p class="ellipsis">Cum sociis natoque penatibus et magnis dis parturient montes</p>
													</div></a>
												...
												<li> <a href="javascript:void(0);">
													<div class="icon-circle"> <img src="{{asset('assets/images/xs/avatar3.jpg')}}" alt=""> </div>
													<div class="menu-info">
														<h4>Thomas</h4>
														<p class="ellipsis">Cum sociis natoque penatibus et magnis dis parturient montes</p>
													</div></a>
												...
												<li><a href="javascript:void(0);">
													<div class="icon-circle"> <img src="{{asset('assets/images/xs/avatar4.jpg')}}" alt=""> </div>
													<div class="menu-info">
														<h4>William</h4>
														<p class="ellipsis">Cum sociis natoque penatibus et magnis dis parturient montes</p>
													</div></a> 
		...
		<aside id="leftsidebar" class="sidebar"><!-- Menu -->
			<div class="menu">
				<ul class="list">
					<li><!-- User Info -->
						<div class="user-info">
							<div class="admin-image"> <img src="{{asset('assets/images/vishal.jpg')}}" alt="profile img"> </div>
					...
					<li>
						<a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account"></i><span>Administration</span> </a>
							<ul class="ml-menu">
								<li><a href="{{url('add_administration')}}">Add Administration</a></li>
					...
					<li>
						<a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account"></i><span>Professors</span> </a>
							<ul class="ml-menu">
								<li><a href="{{url('add_professor')}}">Add professors</a></li>
								<li><a href="{{url('add_achivement')}}">Add achivement</a></li>
								<li><a href="{{url('professor')}}">All Professors</a></li>
								<li><a href="{{url('achivement')}}">Achivement</a></li>
							</ul>
					</li>
					<li>
						<a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Event Management</span> </a>
							<ul class="ml-menu">
								<li><a href="{{url('add_event')}}">Add Events</a></li>
								<li><a href="{{url('event')}}">All Events</a></li>
								<li><a href="{{url('add_sub_event')}}">Add Sub Events</a></li>
								<li><a href="{{url('sub_event')}}">All Sub Events</a></li>
							</ul>
					</li>
					<li>
						<a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-book"></i><span>Library</span> </a>
						<ul class="ml-menu">
							<li><a href="{{url('add_library')}}">Add Library</a></li>
							<li><a href="{{url('library')}}">All Library</a></li>
						</ul>
					</li>	
					<li>
						<a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-mood"></i><span>Staffs</span> </a>
						<ul class="ml-menu">
							<li><a href="{{url('staff')}}">Add Staffs</a></li>
							<li><a href="{{url('staff')}}">All Staffs</a></li>
							<li><a href="staffs-info.html">Staffs Profile</a></li>
						</ul>
					</li>
					<li>
						<a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city-alt"></i><span>T & P</span> </a>
						<ul class="ml-menu">
							<li><a href="{{url('add_tnp')}}">Add T & P</a></li>
							<li><a href="{{url('tnp')}}">All T & P</a></li>
						</ul>
					</li>
