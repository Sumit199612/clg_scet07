		...
		<div class="row clearfix">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class=" card patient-profile">
                    <img src='{{ asset($findprof->proflie)}}' class="img-responsive" alt="">                              
                </div>
                <div class="card">
                    <div class="header">
					...
					<div class="body">
                        <strong>Name</strong>
						<p>{{$findprof->position}}.{{$findprof->fname}} {{$findprof->lname}}</p>
						<strong>Department</strong>
						<p>{{$findprof->depart_full_name}}</p>
                        ...
                        <p>{{$findprof->Qualification}}</p>
						<strong>exprience</strong>
						<p>{{$findprof->exprience}}</p>
                    </div>
                </div>
            </div>
