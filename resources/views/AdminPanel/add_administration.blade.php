        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
                    ...
                    <form action="/administration" class="" method="post" enctype="multipart/form-data">
                    @csrf
					<div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="a_name" placeholder="Administration Name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="expirence" placeholder="Expirence">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-12">
