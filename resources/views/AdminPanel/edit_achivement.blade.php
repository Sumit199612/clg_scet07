                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group drop-custum">
                                    ...
                                    <select class="form-control show-tick" name="prof_id" required>
                                        <option value="">Select Professor</option>
												...
												<option selected="selected" value="{{$prof->fname}}{{$prof->lname}}"></option>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="5" class="form-control no-resize" placeholder="Achivements Detail" name="details" >{{$findachivement->Add_Details}}</textarea>
                                    </div>
                                </div>
                            </div>
								<div class="col-xs-12">
