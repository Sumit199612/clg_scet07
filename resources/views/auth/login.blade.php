            ...
            <div class="row clearfix">
                <div class="col-lg-5 col-md-8 col-xs-12 p-l-0">
                    <div class="l-detail">
                        ...
                        <h1 class="position"><img src="{{asset('assets/images/scet1.jpg')}}" alt="profile img"><span>S</span>cet</h1>
                        <h3 class="position">Sign in to start your session</h3>
                        <p class="position">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type
                            specimen book.</p>
